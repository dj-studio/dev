...
window.addEventListener('resize', calculatePadding);
    ...
    // Updated code with easing and duration changes

    const timeline = gsap.timeline({
      scrollTrigger: {
        trigger: ".navbar",
        start: "top+=20px center", // Animation starts when the top of the viewport is 20px below the top of .navbar
        end: "top center", // Animation ends when the top of the viewport aligns with the top of .navbar
