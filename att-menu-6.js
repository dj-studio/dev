...
function closeMegaMenu() {
  ...
  openMenus.forEach(menu => {
    ...
    const whiteDesktopNavLink = menu.querySelectorAll('.white-desktop-nav-link');
    const whiteNavbarLogo = menu.querySelectorAll('.white-navbar-logo');
    const whiteSignIn = menu.querySelectorAll('.white-sign-in');
    const whiteCTAButton = menu.querySelectorAll('.white-cta-button');
