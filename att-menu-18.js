...
// Updated code with body as the trigger

const timeline = gsap.timeline({
  scrollTrigger: {
    trigger: "body", // Use the body element as the trigger
    start: "top+=20px center", // Animation starts when the top of the viewport is 20px below the top of the body
    end: "top center", // Animation ends when the top of the viewport aligns with the top of the body
