...
function closeMegaMenu() {
  ...
  openMenus.forEach(menu => {
        ...
        const desktopNavLink = document.querySelector('.desktop-nav-link');
        const megaMenuDropdown = document.querySelector('.mega-menu-dropdown');
        const carrotSpan = document.querySelector('.carrot-span');
        const megaLinkColumns = document.querySelectorAll('.mega-menu-link-column'); // Select the mega menu link columns
        const megaMenuAd = document.querySelectorAll('.mega-menu-webinar-column'); // Select the mega menu link columns
...
window.addEventListener('click', function (event) {
  ...
  if (!target.closest('.link-wrap') && !target.closest('.mega-menu-dropdown')) {
    closeMegaMenu();
  }
});
